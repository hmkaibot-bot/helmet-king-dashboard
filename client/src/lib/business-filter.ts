...
/**
 * 查詢事件係咪零售 — inquiry_events.business 由 SleekFlow 條線判定
 * (零售 Main WhatsApp / @helmetking_hk IG / 頭盔王 FB page = retail;
 *  26King WhatsApp·IG = 26king;租車線 = rental)。
 * null = 舊行/未識別 — 當零售計(webhook 只掛零售線,歷史行都係零售為主)。
 */
